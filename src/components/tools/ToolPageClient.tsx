  ...
  return (
    <main className="min-h-screen" style={{ background: '#f5f2ec' }}>
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 py-16 sm:py-24">
        ...
        <Link href="/tools"
          className="inline-flex items-center text-sm text-[#6b7280] hover:text-[#0d0d0d] transition-colors mb-10"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-3">
            ...
            <h1 className="text-4xl sm:text-5xl text-[#0d0d0d] mb-4"
              style={{ fontFamily: 'var(--font-serif)', lineHeight: 1.15 }}>
              {tool.title}
            </h1>
            <p className="text-lg text-[#6b7280] leading-relaxed mb-8" style={{ fontFamily: 'var(--font-outfit)' }}>
              {tool.description}
            </p>

            <div className="bg-white border border-[#e5e5e5] rounded-[10px] p-6">
              <h2 className="text-base font-semibold text-[#0d0d0d] mb-4" style={{ fontFamily: 'var(--font-outfit)' }}>
                What&rsquo;s inside
              </h2>
                ...
                {tool.whatsInside.map((item, i) => (
                  <li key={i} className="flex items-start gap-3 text-sm text-[#374151]"
                    ...
                    <span className="mt-0.5 flex-shrink-0 w-4 h-4 rounded-full flex items-center justify-center"
                      ...
                      <svg className="w-2.5 h-2.5" style={{ color: '#1a6b4a' }} fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white border border-[#e5e5e5] rounded-[10px] p-6 sticky top-28">
              <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-widest mb-5 px-3 py-2 rounded-[4px]"
              ...
              <h3 className="text-base font-semibold text-[#0d0d0d] mb-4" style={{ fontFamily: 'var(--font-outfit)' }}>
                Your free resource
              </h3>

              <a href={tool.resourceUrl} target="_blank" rel="noopener noreferrer"
                className="block w-full text-center py-3 rounded-[4px] text-sm font-semibold text-white transition-opacity hover:opacity-90 mb-3"
              ...
              {tool.videoUrl && (
                <a href={tool.videoUrl} target="_blank" rel="noopener noreferrer"
                  className="block w-full text-center py-3 rounded-[4px] text-sm font-semibold border border-[#e5e5e5] text-[#374151] hover:border-[#0d0d0d] transition-colors mb-3"
                  style={{ fontFamily: 'var(--font-outfit)' }}>
                  Watch walkthrough
                </a>
              )}
              ...
              <div className="border-t border-[#e5e5e5] pt-4 flex flex-col gap-2">
                {tool.communityUrl && (
                  <a href={tool.communityUrl} target="_blank" rel="noopener noreferrer"
                    className="flex items-center gap-2.5 px-3 py-2.5 rounded-[4px] text-sm font-medium"
                    style={{ background: '#e7f9ee', color: '#128c5e', fontFamily: 'var(--font-outfit)' }}>
                ...
                <a href="https://www.linkedin.com/in/tusharmanglatm/" target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-2.5 px-3 py-2.5 rounded-[4px] text-sm font-medium"
                  style={{ background: '#e8f0fb', color: '#0a66c2', fontFamily: 'var(--font-outfit)' }}>
